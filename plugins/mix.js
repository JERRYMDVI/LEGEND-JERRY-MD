...
cmd({
  ...
  try {
    ...
    return _0x5ce77a("*🪄 JERRY-MD GPT SERVER 🪩*\n\n " + _0x5457fa.result);
  } catch (_0x18fd4d) {
...
cmd({
  ...
  try {
    ...
    await _0x4315e4.sendMessage(_0x50a577, {
      'text': "✉️ *TEMPORARY EMAIL GENERATED BY JERRY-MD*\n\n📧 Email: " + _0x3cd41a,
      'footer': "test"
    }, {
      'quoted': _0x554b09
    });
...
cmd({
  ...
  try {
    if (!_0x3c2b7a) {
      return await _0xc99a29("*JERRY-MD MFIRE DL*");
    }
